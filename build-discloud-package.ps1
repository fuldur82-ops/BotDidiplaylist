...
Copy-Item -LiteralPath (Join-Path $projectRoot "main.py"), (Join-Path $projectRoot "requirements.txt"), (Join-Path $projectRoot "discloud.config"), (Join-Path $projectRoot "README.md") -Destination $stage
